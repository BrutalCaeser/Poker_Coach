...
const scenario1 = {
  ...
  players: [
    { name: "You", position: "CO", stack: 10000, cards: ["As", "Kd"], behaviour: null },
    { name: "Marcus", position: "BB", stack: 10000, cards: ["Qd", "Jh"], behaviour: "Loose-Passive" },
  ],
  ...
  actions: [
    ...
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 300 },
    { type: "bet", player: 1, name: "Marcus", action: "calls", amount: 300 },
    { type: "info", text: "Pot: $650" },
    { type: "board", cards: ["Qh", "7s", "2d"] },
    { type: "info", text: "Flop: Q\u26657\u26602\u2666 \u2014 You missed, but have two overcards." },
    { type: "bet", player: 1, name: "Marcus", action: "bets", amount: 325 },
    { type: "info", text: "Marcus bets $325 (half pot) into $650. Pot is now $975." },
...
const scenario2 = {
  ...
  players: [
    { name: "You", position: "BTN", stack: 15000, cards: ["As", "9s"], behaviour: null },
    { name: "James", position: "BB", stack: 15000, cards: ["Kh", "Qd"], behaviour: "Tight-Aggressive" },
  ],
  blinds: { small: 50, big: 100, ante: 0 },
  heroIndex: 0,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $50/$100" },
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 250 },
    { type: "bet", player: 1, name: "James", action: "calls", amount: 250 },
    ...
    { type: "bet", player: 1, name: "James", action: "bets", amount: 275 },
    { type: "info", text: "James bets $275 (half pot) into $550. Pot is now $825." },
...
const scenario3 = {
  ...
  players: [
    { name: "You", position: "BTN", stack: 10000, cards: ["As", "Ks"], behaviour: null },
    { name: "Nadia", position: "BB", stack: 10000, cards: ["Qh", "Qd"], behaviour: "Tight-Aggressive" },
  ],
  blinds: { small: 50, big: 100, ante: 0 },
  heroIndex: 0,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $50/$100" },
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 300 },
    { type: "bet", player: 1, name: "Nadia", action: "3-bets to", amount: 1000 },
    { type: "bet", player: 0, name: "You", action: "4-bets to", amount: 2500 },
    { type: "bet", player: 1, name: "Nadia", action: "shoves all-in for", amount: 10000 },
    { type: "info", text: "Nadia shoves all-in for $10,000. Pot is $12,550 ($50 SB + $2,500 your 4-bet + $10,000 shove)." },
    { type: "info", text: "You put Nadia on QQ. This is a classic coin flip \u2014 your AKs vs their QQ." },
...
const scenario4 = {
  ...
  actions: [
    ...
    { type: "bet", player: 1, name: "Rafael", action: "folds", amount: 0 },
    { type: "bet", player: 0, name: "Luca", action: "shoves all-in for", amount: 45000 },
    { type: "info", text: "Luca shoves all-in. He's been aggressive and is likely shoving a very wide range." },
...
const scenario5 = {
  ...
  players: [
    { name: "You", position: "MP", stack: 10000, cards: ["Ac", "Kd"], behaviour: null },
    { name: "Anton", position: "BB", stack: 10000, cards: ["8d", "8s"], behaviour: "Calling Station" },
  ],
  blinds: { small: 50, big: 100, ante: 0 },
  heroIndex: 0,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $50/$100" },
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 300 },
    { type: "bet", player: 1, name: "Anton", action: "calls", amount: 300 },
    { type: "info", text: "Pot: $650" },
    { type: "board", cards: ["8h", "5c", "2d"] },
    { type: "info", text: "Flop: 8\u26655\u26632\u2666 \u2014 Dry board. You completely missed." },
    { type: "bet", player: 1, name: "Anton", action: "bets", amount: 650 },
    { type: "info", text: "Anton bets $650 (full pot) into $650. Pot is now $1,300." },
...
const scenario6 = {
  ...
  players: [
    { name: "Kenji", position: "CO", stack: 800000, cards: ["Ac", "Qc"], behaviour: "Tight-Aggressive" },
    { name: "Sergei", position: "BTN", stack: 900000, cards: ["Kh", "Ks"], behaviour: "Nit" },
    { name: "You", position: "BB", stack: 400000, cards: ["Jd", "Jc"], behaviour: null },
  ],
  ...
  actions: [
    ...
    { type: "bet", player: 0, name: "Kenji", action: "raises to", amount: 80000 },
    { type: "bet", player: 1, name: "Sergei", action: "3-bets to", amount: 200000 },
    { type: "info", text: "Kenji raises, then Sergei 3-bets. You're in the BB with JJ." },
...
const scenario7 = {
  ...
  players: [
    { name: "Viktor", position: "UTG", stack: 25000, cards: ["Ah", "Kh"], behaviour: "Tight-Aggressive" },
    { name: "You", position: "BB", stack: 25000, cards: ["5s", "5h"], behaviour: null },
  ],
  ...
  actions: [
    ...
    { type: "bet", player: 0, name: "Viktor", action: "raises to", amount: 1500 },
    { type: "info", text: "Viktor raises from UTG to $1,500. Action is on you." },
...
const scenario8 = {
  ...
  players: [
    { name: "Elena", position: "UTG", stack: 20000, cards: ["Ad", "Jd"], behaviour: "Loose-Aggressive" },
    { name: "You", position: "BTN", stack: 20000, cards: ["Ts", "9s"], behaviour: null },
  ],
  blinds: { small: 100, big: 200, ante: 0 },
  heroIndex: 1,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $100/$200" },
    { type: "bet", player: 0, name: "Elena", action: "raises to", amount: 600 },
    { type: "bet", player: 1, name: "You", action: "calls", amount: 600 },
    ...
    { type: "bet", player: 0, name: "Elena", action: "bets", amount: 900 },
    { type: "info", text: "Elena bets $900 into $1,300. Pot is now $2,200." },
...
const scenario9 = {
  ...
  players: [
    { name: "You", position: "BTN", stack: 15000, cards: ["9s", "8d"], behaviour: null },
    { name: "Daniel", position: "BB", stack: 50000, cards: ["Jc", "Td"], behaviour: "Tight-Aggressive" },
  ],
  ...
  actions: [
    ...
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 1000 },
    { type: "bet", player: 1, name: "Daniel", action: "calls", amount: 1000 },
    { type: "info", text: "Pot: $2,200" },
    { type: "board", cards: ["Jh", "5c", "3s"] },
    { type: "info", text: "Flop: J\u26655\u26633\u2660 \u2014 You missed. Just a backdoor straight draw." },
    { type: "bet", player: 1, name: "Daniel", action: "bets", amount: 1100 },
    { type: "bet", player: 0, name: "You", action: "calls", amount: 1100 },
    ...
    { type: "bet", player: 1, name: "Daniel", action: "bets", amount: 4400 },
    { type: "info", text: "Daniel bets $4,400 (full pot). Pot is now $8,800. You have $12,900 left." },
...
const scenario10 = {
  ...
  players: [
    { name: "You", position: "CO", stack: 15000, cards: ["Ks", "Kc"], behaviour: null },
    { name: "Wei", position: "BB", stack: 15000, cards: ["9h", "7h"], behaviour: "Loose-Passive" },
  ],
  blinds: { small: 50, big: 100, ante: 0 },
  heroIndex: 0,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $50/$100" },
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 300 },
    { type: "bet", player: 1, name: "Wei", action: "calls", amount: 300 },
    { type: "info", text: "Pot: $650" },
    { type: "board", cards: ["Th", "6h", "3d"] },
    { type: "info", text: "Flop: T\u26656\u26653\u2666 \u2014 You have an overpair. Two hearts on board." },
    { type: "bet", player: 0, name: "You", action: "bets", amount: 450 },
    { type: "bet", player: 1, name: "Wei", action: "calls", amount: 450 },
    { type: "info", text: "Wei calls. Pot: $1,550." },
    { type: "board", cards: ["2h"] },
    { type: "info", text: "Turn: 2\u2665 \u2014 The third heart arrives. Flush is now possible." },
    { type: "bet", player: 1, name: "Wei", action: "bets", amount: 1200 },
    { type: "info", text: "Wei leads out for $1,200 into $1,550. This is a big bet on the flush-completing card." },
...
const scenario11 = {
  ...
  players: [
    { name: "You", position: "CO", stack: 50000, cards: ["As", "Kc"], behaviour: null },
    { name: "Tomás", position: "BTN", stack: 50000, cards: ["Qd", "Qh"], behaviour: "Tight-Aggressive" },
  ],
  blinds: { small: 200, big: 400, ante: 0 },
  heroIndex: 0,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $200/$400" },
    { type: "bet", player: 0, name: "You", action: "raises to", amount: 1000 },
    { type: "bet", player: 1, name: "Tomás", action: "3-bets to", amount: 3200 },
    { type: "info", text: "Tomás 3-bets you from the Button to $3,200." },
...
const scenario12 = {
  ...
  players: [
    { name: "Nadia", position: "UTG", stack: 20000, cards: ["Ad", "Jd"], behaviour: "Loose-Aggressive" },
    { name: "You", position: "CO", stack: 20000, cards: ["8s", "7s"], behaviour: null },
  ],
  blinds: { small: 100, big: 200, ante: 0 },
  heroIndex: 1,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $100/$200" },
    { type: "bet", player: 0, name: "Nadia", action: "raises to", amount: 600 },
    { type: "bet", player: 1, name: "You", action: "calls", amount: 600 },
    { type: "info", text: "Pot: $1,300" },
    { type: "board", cards: ["9s", "6s", "2c"] },
    { type: "info", text: "Flop: 9\u26606\u26602\u2663 \u2014 Monster draw! Flush draw + open-ended straight draw." },
    { type: "bet", player: 0, name: "Nadia", action: "bets", amount: 800 },
    { type: "info", text: "Nadia bets $800 into $1,300. Pot is now $2,100." },
...
const scenario13 = {
  ...
  players: [
    { name: "Kenji", position: "UTG", stack: 10000, cards: ["9h", "8h"], behaviour: "Loose-Passive" },
    { name: "Sergei", position: "MP", stack: 10000, cards: ["Jc", "Tc"], behaviour: "Calling Station" },
    { name: "Marcus", position: "BTN", stack: 10000, cards: ["6d", "6s"], behaviour: "Tight-Passive" },
    { name: "You", position: "BB", stack: 10000, cards: ["Ac", "Kd"], behaviour: null },
  ],
  blinds: { small: 50, big: 100, ante: 0 },
  heroIndex: 3,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $50/$100" },
    { type: "bet", player: 0, name: "Kenji", action: "limps", amount: 100 },
    { type: "bet", player: 1, name: "Sergei", action: "limps", amount: 100 },
    { type: "bet", player: 2, name: "Marcus", action: "limps", amount: 100 },
    ...
    { type: "bet", player: 0, name: "Kenji", action: "bets", amount: 300 },
    { type: "bet", player: 1, name: "Sergei", action: "calls", amount: 300 },
    { type: "bet", player: 2, name: "Marcus", action: "folds", amount: 0 },
    { type: "info", text: "Kenji bets $300, Sergei calls. Pot is now $1,000. Action is on you." },
...
const scenario14 = {
  ...
  players: [
    { name: "Viktor", position: "UTG", stack: 30000, cards: ["Ad", "Td"], behaviour: "Tight-Aggressive" },
    { name: "You", position: "BTN", stack: 30000, cards: ["Kd", "Qd"], behaviour: null },
  ],
  blinds: { small: 100, big: 200, ante: 0 },
  heroIndex: 1,
  board: [],
  ...
  actions: [
    ...
    { type: "info", text: "Blinds posted: $100/$200" },
    { type: "bet", player: 0, name: "Viktor", action: "raises to", amount: 600 },
    { type: "bet", player: 1, name: "You", action: "calls", amount: 600 },
    { type: "info", text: "Pot: $1,300" },
    { type: "board", cards: ["7d", "3d", "As"] },
    { type: "info", text: "Flop: 7\u26663\u2666A\u2660 \u2014 Two diamonds! You have the King-high flush draw." },
    { type: "bet", player: 0, name: "Viktor", action: "bets", amount: 800 },
    { type: "bet", player: 1, name: "You", action: "calls", amount: 800 },
    { type: "info", text: "Pot: $2,900" },
    { type: "board", cards: ["9d"] },
    { type: "info", text: "Turn: 9\u2666 \u2014 You made a flush! King-high flush. But wait..." },
    { type: "info", text: "Viktor raised preflop from UTG. The A\u2666 is still out there. If Viktor has A\u2666x\u2666, you're crushed." },
    { type: "bet", player: 0, name: "Viktor", action: "bets", amount: 2200 },
    { type: "info", text: "Viktor bets $2,200 into $2,900. Pot is now $5,100." },
